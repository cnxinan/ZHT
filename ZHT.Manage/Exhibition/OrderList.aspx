<%@ Page Language="C#"  MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="ZHT.Manage.Exhibition.OrderList" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="Content" runat="server">
    ...
    <form id="export" method="post" action="Order.ashx">
...
<asp:Content ID="Content9" ContentPlaceHolderID="ExtScript" runat="server">
    <script type="text/javascript">
        ...
        function PageMethod() {
            ...
            var Status = $('#ddlStatus_list').val();

            $.ajax({
                type: "Post",
                url: "Order.ashx?type=GetList",
                data: {
            ...
            function GetProtocolRruleInfo(result) {
                ...
                valueStr += "<th>展商名称</th><th>订单号</th><th>用户姓名</th><th>手机号</th><th>总金额/元</th><th>提货状态</th><th>操作</th>";
                ...
                if (listdata != null && listdata != "") {
                    ...
                    $(eval(listdata)).each(function (i) {
                        valueStr += "</tr>"
                             + "<td><div class='checkbox' value='" + this['Code'] + "' onclick='check(this);'><input type='checkbox' id='" + this['OrderId'] + "' name='items' /></div></td>"
                             ...
                             + "<td>" + this['Status'] + "&nbsp;</td>"
                             + "<td><a href='/Exhibition/OrderDetails.aspx?ExhibitionId=" + ExhibitionId + "&OrderId=" + this['OrderId'] + "' target='_self'>" + "查看" + "</a>&nbsp;</td>"
                             + "</tr>";
                    });
                }
