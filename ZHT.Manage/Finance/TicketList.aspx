<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="TicketList.aspx.cs" Inherits="ZHT.Manage.Finance.TicketList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="RightNav" runat="server">
    <ul>
        <li class="current"><a href="TicketList.aspx">门票收入</a></li>
...
<asp:Content ID="Content7" ContentPlaceHolderID="Content" runat="server">
    ...
    <form id="export" method="post" action="Statistics.ashx">
        ...
        <input type="hidden" name="listType" value="ticket" />
...
<asp:Content ID="Content9" ContentPlaceHolderID="ExtScript" runat="server">
    <script type="text/javascript">
        ...
        function PageMethod() {
            ...
            $.ajax({
                type: "Post",
                url: "Statistics.ashx?type=TicketList",
                data: {
                    "PageSize": pagesize,
                    "PageIndex": pageindex,
                    "Title": Title,
            ...
            function GetProtocolRruleInfo(result) {
                ...
                valueStr += "<th>展会名称</th><th>完成时间</th><th>门票数量</th><th>总金额/元</th><th>结算金额</th><th>结算状态</th>";
